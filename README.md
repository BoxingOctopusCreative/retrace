...
Grab the latest release for your platform from the [Releases page](https://github.com/BoxingOctopusCreative/retrace/releases).

No installer wizard, no sign-up flow. Download, open, trace.

---

## Enhanced backends (optional)
...
Re:Trace is released under the [Mozilla Public License 2.0](https://www.mozilla.org/en-US/MPL/2.0/). You can use it, modify it, and redistribute it. If you make changes to the Re:Trace source files, those changes must remain open source, but you can use Re:Trace alongside proprietary code in your own projects.

Contributions welcome. See [Issues](https://github.com/BoxingOctopusCreative/retrace/issues) for what's being worked on.

---

Built by [BOC Engineering](https://boxingoctop.us)
